...
set ylabel "Average Number of Drivers"
set output "2nd_graph.pdf" #GNU FILE
...
set boxwidth 1
#set xtic scale 0
plot 'drivers.dat' using 2:xtic(1) title "RDSMP" lt rgb '#0072bd',\
     "" using 3 title "ERDSMP" lt rgb "#7e2f8e",\
     "ddataa.txt" using 2 title "LAF" lt rgb "#77ac30"  
