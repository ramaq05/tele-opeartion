...
RDSMP = "#99ffff"; ERDSMP = "#4671d5"
set key left
set grid #GNU FILE

set xlabel "Latency Constraint,L"
set ylabel "Average Network Distance"
set output "3rd_graph.pdf" #GNU FILE
...
set boxwidth 1
#set xtic scale 0
plot 'distance.dat' using 2:xtic(1) title "RDSMP" lt rgb "#0072bd",\
     "" using 3 title "ERDSMP" lt rgb "#7e2f8e",\
     'ddataa.txt' using 3 title "LAF" lt rgb "#77ac30"
